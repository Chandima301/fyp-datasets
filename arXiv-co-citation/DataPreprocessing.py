...
if __name__ == "__main__":
    edges = read_dataset("../../datasets/ca-cit-HepPh/out.ca-cit-HepPh")
    node_features = create_node_features(edges, node_degree=True, page_rank=False, graph_coloring=True, triangle_count=True)
    save_dataset(edges, node_features,  edge_list_file_path="arXiv-co-citation_edges.csv", node_list_file_path="arXiv-co-citation_nodes.csv")
